...
try:
    from data_processor import process_uploaded_data, generate_response
    from layout import render_header
except ImportError:
    # Fallback if direct import fails (e.g. running from root)
    try:
        from View.frontend.utils.data_processor import process_uploaded_data, generate_response
        from View.frontend.utils.layout import render_header
    except ImportError:
