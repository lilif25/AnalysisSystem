...
# current_dir is .../View/backend/api/routes
# We need to go up 3 levels to reach View
view_dir = os.path.abspath(os.path.join(current_dir, "../../.."))
models_dir = os.path.join(view_dir, "models")
